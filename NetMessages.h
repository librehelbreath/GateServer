...
// v1.4311-3 추가 메세지 선언 입장권 받기위한 메세지  길드에서 강퇴됨
// DEF_COMMONTYPE_REQ_GETOCCUPYFIGHTZONETICKET DEF_COMMONTYPE_BANGUILD
...
// v1.4311-3 메세지 선언 선언 사투장 예약이 취소 및 길드 마스터 명령 사용권한이
// 없음을 알림 #define DEF_NOTIFY_SUCCESSBANGUILDMAN			0x0B82
...
#define MSGID_RESPONSE_LOG \
  0x0FC94203  // Login, createnewaccount, createnewcharacter, deletecharacter
              // 등등에 대한 응답
...
#define MSGID_REQUEST_SAVEPLAYERDATA_REPLY \
  0x0DF30770  // 로그서버로부터 세이브됨의 응답을 받아야 하는 경우
